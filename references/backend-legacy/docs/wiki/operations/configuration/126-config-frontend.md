...
# 126-config-frontend — frontend/config
...
- [`frontend/src-tauri/.gitignore`](../../../../frontend/src-tauri/.gitignore)
- [`frontend/src-tauri/Cargo.lock`](../../../../frontend/src-tauri/Cargo.lock)
...
- [`frontend/src-tauri/capabilities/whatsapp-companion-relay.json`](../../../../frontend/src-tauri/capabilities/whatsapp-companion-relay.json)
- [`frontend/src-tauri/capabilities/yandex-telemost-companion-relay.json`](../../../../frontend/src-tauri/capabilities/yandex-telemost-companion-relay.json)
- [`frontend/src-tauri/permissions/autogenerated/open_whatsapp_web_companion.toml`](../../../../frontend/src-tauri/permissions/autogenerated/open_whatsapp_web_companion.toml)
- [`frontend/src-tauri/permissions/autogenerated/open_yandex_telemost_companion.toml`](../../../../frontend/src-tauri/permissions/autogenerated/open_yandex_telemost_companion.toml)
- [`frontend/src-tauri/permissions/autogenerated/whatsapp_web_companion_manifest.toml`](../../../../frontend/src-tauri/permissions/autogenerated/whatsapp_web_companion_manifest.toml)
- [`frontend/src-tauri/permissions/autogenerated/whatsapp_web_companion_relay_observation.toml`](../../../../frontend/src-tauri/permissions/autogenerated/whatsapp_web_companion_relay_observation.toml)
- [`frontend/src-tauri/permissions/autogenerated/yandex_telemost_companion_manifest.toml`](../../../../frontend/src-tauri/permissions/autogenerated/yandex_telemost_companion_manifest.toml)
- [`frontend/src-tauri/permissions/autogenerated/yandex_telemost_prepare_audio_device.toml`](../../../../frontend/src-tauri/permissions/autogenerated/yandex_telemost_prepare_audio_device.toml)
- [`frontend/src-tauri/permissions/autogenerated/yandex_telemost_recording_start.toml`](../../../../frontend/src-tauri/permissions/autogenerated/yandex_telemost_recording_start.toml)
- [`frontend/src-tauri/permissions/autogenerated/yandex_telemost_recording_stop.toml`](../../../../frontend/src-tauri/permissions/autogenerated/yandex_telemost_recording_stop.toml)
- [`frontend/src-tauri/permissions/autogenerated/yandex_telemost_speaker_timeline_append.toml`](../../../../frontend/src-tauri/permissions/autogenerated/yandex_telemost_speaker_timeline_append.toml)
- [`frontend/src-tauri/tauri.conf.json`](../../../../frontend/src-tauri/tauri.conf.json)
- [`frontend/src/platform/i18n/en.json`](../../../../frontend/src/platform/i18n/en.json)
- [`frontend/src/platform/i18n/ru.json`](../../../../frontend/src/platform/i18n/ru.json)
