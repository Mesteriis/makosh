---
chunk_id: 091-test-backend-part-014
...
# 091-test-backend-part-014 — backend/test
...
- [`backend/tests/telegram_references_members.rs`](../../../../backend/tests/telegram_references_members.rs)
- [`backend/tests/telegram_reply_forward_capability_gates.rs`](../../../../backend/tests/telegram_reply_forward_capability_gates.rs)
- [`backend/tests/telegram_runtime_lifecycle.rs`](../../../../backend/tests/telegram_runtime_lifecycle.rs)
- [`backend/tests/telegram_search_pinning.rs`](../../../../backend/tests/telegram_search_pinning.rs)
- [`backend/tests/telegram_support/mod.rs`](../../../../backend/tests/telegram_support/mod.rs)
- [`backend/tests/telegram_topic_capability_gates.rs`](../../../../backend/tests/telegram_topic_capability_gates.rs)
- [`backend/tests/timeline_engine.rs`](../../../../backend/tests/timeline_engine.rs)
- [`backend/tests/trust_engine.rs`](../../../../backend/tests/trust_engine.rs)
- [`backend/tests/v1_api.rs`](../../../../backend/tests/v1_api.rs)
- [`backend/tests/v1_communications_ai_state.rs`](../../../../backend/tests/v1_communications_ai_state.rs)
- [`backend/tests/v1_communications_api.rs`](../../../../backend/tests/v1_communications_api.rs)
- [`backend/tests/v1_communications_archive_inspection.rs`](../../../../backend/tests/v1_communications_archive_inspection.rs)
- [`backend/tests/v1_communications_attachment_preview.rs`](../../../../backend/tests/v1_communications_attachment_preview.rs)
