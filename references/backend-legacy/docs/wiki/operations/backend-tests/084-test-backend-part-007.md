---
chunk_id: 084-test-backend-part-007
...
# 084-test-backend-part-007 — backend/test
...
- [`backend/tests/graph_api/neighborhood.rs`](../../../../backend/tests/graph_api/neighborhood.rs)
- [`backend/tests/graph_api/search.rs`](../../../../backend/tests/graph_api/search.rs)
- [`backend/tests/graph_api/support.rs`](../../../../backend/tests/graph_api/support.rs)
- [`backend/tests/graph_api_architecture.rs`](../../../../backend/tests/graph_api_architecture.rs)
- [`backend/tests/graph_projection.rs`](../../../../backend/tests/graph_projection.rs)
- [`backend/tests/graph_projection/idempotence.rs`](../../../../backend/tests/graph_projection/idempotence.rs)
- [`backend/tests/graph_projection/project_links.rs`](../../../../backend/tests/graph_projection/project_links.rs)
- [`backend/tests/graph_projection/support.rs`](../../../../backend/tests/graph_projection/support.rs)
- [`backend/tests/graph_projection_architecture.rs`](../../../../backend/tests/graph_projection_architecture.rs)
- [`backend/tests/hard_v1_routes.rs`](../../../../backend/tests/hard_v1_routes.rs)
- [`backend/tests/health.rs`](../../../../backend/tests/health.rs)
- [`backend/tests/mail_archive_inspection.rs`](../../../../backend/tests/mail_archive_inspection.rs)
- [`backend/tests/mail_storage.rs`](../../../../backend/tests/mail_storage.rs)
- [`backend/tests/memory_engine.rs`](../../../../backend/tests/memory_engine.rs)
- [`backend/tests/message_flags_api.rs`](../../../../backend/tests/message_flags_api.rs)
- [`backend/tests/messages.rs`](../../../../backend/tests/messages.rs)
- [`backend/tests/messages/analysis.rs`](../../../../backend/tests/messages/analysis.rs)
- [`backend/tests/messages/projection_core.rs`](../../../../backend/tests/messages/projection_core.rs)
- [`backend/tests/messages/projection_queries.rs`](../../../../backend/tests/messages/projection_queries.rs)
- [`backend/tests/messages/support.rs`](../../../../backend/tests/messages/support.rs)
