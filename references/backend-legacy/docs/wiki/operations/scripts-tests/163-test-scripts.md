...
# 163-test-scripts — scripts/test

- Target index: [[operations/scripts-tests]]
...
- [`scripts/test/analyze-nextest-junit.mjs`](../../../../scripts/test/analyze-nextest-junit.mjs)
- [`scripts/test/backend-test-targets.mjs`](../../../../scripts/test/backend-test-targets.mjs)
- [`scripts/test/collect-performance-reports.sh`](../../../../scripts/test/collect-performance-reports.sh)
- [`scripts/test/run-llvm-cov.sh`](../../../../scripts/test/run-llvm-cov.sh)
- [`scripts/test/run-nextest.sh`](../../../../scripts/test/run-nextest.sh)
