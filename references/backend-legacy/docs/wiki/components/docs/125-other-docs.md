...
# 125-other-docs — docs/other

- Target index: [[components/docs]]
...
- [`docs/site/assets/makosh-logo-mark.png`](../../../site/assets/makosh-logo-mark.png)
- [`docs/site/makosh-docs.css`](../../../site/makosh-docs.css)
