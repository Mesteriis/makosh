---
chunk_id: 042-source-backend-part-022
...
# 042-source-backend-part-022 — backend/source
...
- [`backend/src/domains/communications/saved_searches.rs`](../../../../backend/src/domains/communications/saved_searches.rs)
- [`backend/src/domains/communications/search.rs`](../../../../backend/src/domains/communications/search.rs)
- [`backend/src/domains/communications/service.rs`](../../../../backend/src/domains/communications/service.rs)
- [`backend/src/domains/communications/signatures.rs`](../../../../backend/src/domains/communications/signatures.rs)
- [`backend/src/domains/communications/signatures/certificate_type.rs`](../../../../backend/src/domains/communications/signatures/certificate_type.rs)
- [`backend/src/domains/communications/signatures/detector.rs`](../../../../backend/src/domains/communications/signatures/detector.rs)
- [`backend/src/domains/communications/signatures/errors.rs`](../../../../backend/src/domains/communications/signatures/errors.rs)
- [`backend/src/domains/communications/signatures/models.rs`](../../../../backend/src/domains/communications/signatures/models.rs)
- [`backend/src/domains/communications/signatures/provider.rs`](../../../../backend/src/domains/communications/signatures/provider.rs)
- [`backend/src/domains/communications/signatures/rows.rs`](../../../../backend/src/domains/communications/signatures/rows.rs)
- [`backend/src/domains/communications/signatures/storage_kind.rs`](../../../../backend/src/domains/communications/signatures/storage_kind.rs)
- [`backend/src/domains/communications/signatures/store.rs`](../../../../backend/src/domains/communications/signatures/store.rs)
- [`backend/src/domains/communications/signatures/tests.rs`](../../../../backend/src/domains/communications/signatures/tests.rs)
- [`backend/src/domains/communications/signatures/trust.rs`](../../../../backend/src/domains/communications/signatures/trust.rs)
- [`backend/src/domains/communications/sources.rs`](../../../../backend/src/domains/communications/sources.rs)
- [`backend/src/domains/communications/spf_dkim.rs`](../../../../backend/src/domains/communications/spf_dkim.rs)
- [`backend/src/domains/communications/storage.rs`](../../../../backend/src/domains/communications/storage.rs)
- [`backend/src/domains/communications/storage/blob_store.rs`](../../../../backend/src/domains/communications/storage/blob_store.rs)
- [`backend/src/domains/communications/storage/constants.rs`](../../../../backend/src/domains/communications/storage/constants.rs)
- [`backend/src/domains/communications/storage/errors.rs`](../../../../backend/src/domains/communications/storage/errors.rs)
- [`backend/src/domains/communications/storage/ids.rs`](../../../../backend/src/domains/communications/storage/ids.rs)
- [`backend/src/domains/communications/storage/imports.rs`](../../../../backend/src/domains/communications/storage/imports.rs)
- [`backend/src/domains/communications/storage/models.rs`](../../../../backend/src/domains/communications/storage/models.rs)
- [`backend/src/domains/communications/storage/rows.rs`](../../../../backend/src/domains/communications/storage/rows.rs)
- [`backend/src/domains/communications/storage/scanner.rs`](../../../../backend/src/domains/communications/storage/scanner.rs)
