---
chunk_id: 047-source-backend-part-027
...
# 047-source-backend-part-027 — backend/source
...
- [`backend/src/domains/organizations/memory.rs`](../../../../backend/src/domains/organizations/memory.rs)
- [`backend/src/domains/organizations/mod.rs`](../../../../backend/src/domains/organizations/mod.rs)
- [`backend/src/domains/organizations/ports.rs`](../../../../backend/src/domains/organizations/ports.rs)
- [`backend/src/domains/organizations/service.rs`](../../../../backend/src/domains/organizations/service.rs)
- [`backend/src/domains/organizations/workflows.rs`](../../../../backend/src/domains/organizations/workflows.rs)
- [`backend/src/domains/organizations/workflows/errors.rs`](../../../../backend/src/domains/organizations/workflows/errors.rs)
- [`backend/src/domains/organizations/workflows/playbooks.rs`](../../../../backend/src/domains/organizations/workflows/playbooks.rs)
- [`backend/src/domains/organizations/workflows/portals.rs`](../../../../backend/src/domains/organizations/workflows/portals.rs)
- [`backend/src/domains/organizations/workflows/procedures.rs`](../../../../backend/src/domains/organizations/workflows/procedures.rs)
- [`backend/src/domains/organizations/workflows/templates.rs`](../../../../backend/src/domains/organizations/workflows/templates.rs)
- [`backend/src/domains/organizations/workflows/timeline.rs`](../../../../backend/src/domains/organizations/workflows/timeline.rs)
- [`backend/src/domains/persons/analytics.rs`](../../../../backend/src/domains/persons/analytics.rs)
- [`backend/src/domains/persons/api.rs`](../../../../backend/src/domains/persons/api.rs)
- [`backend/src/domains/persons/api/errors.rs`](../../../../backend/src/domains/persons/api/errors.rs)
- [`backend/src/domains/persons/api/models.rs`](../../../../backend/src/domains/persons/api/models.rs)
- [`backend/src/domains/persons/api/participants.rs`](../../../../backend/src/domains/persons/api/participants.rs)
- [`backend/src/domains/persons/api/rows.rs`](../../../../backend/src/domains/persons/api/rows.rs)
- [`backend/src/domains/persons/api/store.rs`](../../../../backend/src/domains/persons/api/store.rs)
- [`backend/src/domains/persons/api/store/ai_agents.rs`](../../../../backend/src/domains/persons/api/store/ai_agents.rs)
- [`backend/src/domains/persons/api/store/email_projection.rs`](../../../../backend/src/domains/persons/api/store/email_projection.rs)
- [`backend/src/domains/persons/api/store/owner.rs`](../../../../backend/src/domains/persons/api/store/owner.rs)
- [`backend/src/domains/persons/api/store/persona_reads.rs`](../../../../backend/src/domains/persons/api/store/persona_reads.rs)
- [`backend/src/domains/persons/api/store/persona_type.rs`](../../../../backend/src/domains/persons/api/store/persona_type.rs)
- [`backend/src/domains/persons/api/store/persona_writes.rs`](../../../../backend/src/domains/persons/api/store/persona_writes.rs)
- [`backend/src/domains/persons/api/store/review_projection.rs`](../../../../backend/src/domains/persons/api/store/review_projection.rs)
