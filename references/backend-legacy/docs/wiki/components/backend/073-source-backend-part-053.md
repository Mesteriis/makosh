---
chunk_id: 073-source-backend-part-053
...
# 073-source-backend-part-053 — backend/source
...
- [`backend/src/platform/storage/errors.rs`](../../../../backend/src/platform/storage/errors.rs)
- [`backend/src/platform/storage/mod.rs`](../../../../backend/src/platform/storage/mod.rs)
- [`backend/src/platform/storage/models.rs`](../../../../backend/src/platform/storage/models.rs)
- [`backend/src/vault/constants.rs`](../../../../backend/src/vault/constants.rs)
- [`backend/src/vault/crypto.rs`](../../../../backend/src/vault/crypto.rs)
- [`backend/src/vault/errors.rs`](../../../../backend/src/vault/errors.rs)
- [`backend/src/vault/files.rs`](../../../../backend/src/vault/files.rs)
- [`backend/src/vault/key_store.rs`](../../../../backend/src/vault/key_store.rs)
- [`backend/src/vault/lifecycle.rs`](../../../../backend/src/vault/lifecycle.rs)
- [`backend/src/vault/manifest.rs`](../../../../backend/src/vault/manifest.rs)
- [`backend/src/vault/mod.rs`](../../../../backend/src/vault/mod.rs)
- [`backend/src/vault/models.rs`](../../../../backend/src/vault/models.rs)
- [`backend/src/vault/paths.rs`](../../../../backend/src/vault/paths.rs)
- [`backend/src/vault/recovery.rs`](../../../../backend/src/vault/recovery.rs)
- [`backend/src/vault/secrets.rs`](../../../../backend/src/vault/secrets.rs)
- [`backend/src/vault/storage.rs`](../../../../backend/src/vault/storage.rs)
- [`backend/src/workflows/consistency_review.rs`](../../../../backend/src/workflows/consistency_review.rs)
- [`backend/src/workflows/email_fixture_pipeline.rs`](../../../../backend/src/workflows/email_fixture_pipeline.rs)
- [`backend/src/workflows/email_intelligence.rs`](../../../../backend/src/workflows/email_intelligence.rs)
- [`backend/src/workflows/email_intelligence/categories.rs`](../../../../backend/src/workflows/email_intelligence/categories.rs)
- [`backend/src/workflows/email_intelligence/errors.rs`](../../../../backend/src/workflows/email_intelligence/errors.rs)
- [`backend/src/workflows/email_intelligence/heuristics.rs`](../../../../backend/src/workflows/email_intelligence/heuristics.rs)
- [`backend/src/workflows/email_intelligence/models.rs`](../../../../backend/src/workflows/email_intelligence/models.rs)
- [`backend/src/workflows/email_intelligence/prompt.rs`](../../../../backend/src/workflows/email_intelligence/prompt.rs)
- [`backend/src/workflows/email_intelligence/service.rs`](../../../../backend/src/workflows/email_intelligence/service.rs)
