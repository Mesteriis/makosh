---
chunk_id: 040-source-backend-part-020
...
# 040-source-backend-part-020 — backend/source
...
- [`backend/src/domains/communications/folders/events.rs`](../../../../backend/src/domains/communications/folders/events.rs)
- [`backend/src/domains/communications/import.rs`](../../../../backend/src/domains/communications/import.rs)
- [`backend/src/domains/communications/ingestion.rs`](../../../../backend/src/domains/communications/ingestion.rs)
- [`backend/src/domains/communications/legal.rs`](../../../../backend/src/domains/communications/legal.rs)
- [`backend/src/domains/communications/messages.rs`](../../../../backend/src/domains/communications/messages.rs)
- [`backend/src/domains/communications/messages/errors.rs`](../../../../backend/src/domains/communications/messages/errors.rs)
- [`backend/src/domains/communications/messages/ids.rs`](../../../../backend/src/domains/communications/messages/ids.rs)
- [`backend/src/domains/communications/messages/models.rs`](../../../../backend/src/domains/communications/messages/models.rs)
- [`backend/src/domains/communications/messages/payload.rs`](../../../../backend/src/domains/communications/messages/payload.rs)
- [`backend/src/domains/communications/messages/projection.rs`](../../../../backend/src/domains/communications/messages/projection.rs)
- [`backend/src/domains/communications/messages/provider_channel_store.rs`](../../../../backend/src/domains/communications/messages/provider_channel_store.rs)
- [`backend/src/domains/communications/messages/provider_observation_projection.rs`](../../../../backend/src/domains/communications/messages/provider_observation_projection.rs)
- [`backend/src/domains/communications/messages/query_parser.rs`](../../../../backend/src/domains/communications/messages/query_parser.rs)
- [`backend/src/domains/communications/messages/rows.rs`](../../../../backend/src/domains/communications/messages/rows.rs)
- [`backend/src/domains/communications/messages/search.rs`](../../../../backend/src/domains/communications/messages/search.rs)
- [`backend/src/domains/communications/messages/states.rs`](../../../../backend/src/domains/communications/messages/states.rs)
- [`backend/src/domains/communications/messages/store.rs`](../../../../backend/src/domains/communications/messages/store.rs)
- [`backend/src/domains/communications/messages/store/local_state.rs`](../../../../backend/src/domains/communications/messages/store/local_state.rs)
- [`backend/src/domains/communications/messages/store/metadata.rs`](../../../../backend/src/domains/communications/messages/store/metadata.rs)
- [`backend/src/domains/communications/messages/store/participants.rs`](../../../../backend/src/domains/communications/messages/store/participants.rs)
- [`backend/src/domains/communications/messages/store/queries.rs`](../../../../backend/src/domains/communications/messages/store/queries.rs)
