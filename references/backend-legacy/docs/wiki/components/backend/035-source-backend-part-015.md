---
chunk_id: 035-source-backend-part-015
...
# 035-source-backend-part-015 — backend/source
...
- [`backend/src/application/review_inbox.rs`](../../../../backend/src/application/review_inbox.rs)
- [`backend/src/application/review_promotion.rs`](../../../../backend/src/application/review_promotion.rs)
- [`backend/src/application/review_transitions.rs`](../../../../backend/src/application/review_transitions.rs)
- [`backend/src/application/signal_hub_replay.rs`](../../../../backend/src/application/signal_hub_replay.rs)
- [`backend/src/application/task_creation.rs`](../../../../backend/src/application/task_creation.rs)
- [`backend/src/application/telegram_runtime.rs`](../../../../backend/src/application/telegram_runtime.rs)
- [`backend/src/application/whatsapp_command_executor.rs`](../../../../backend/src/application/whatsapp_command_executor.rs)
- [`backend/src/application/whatsapp_provider_observation_reconciliation.rs`](../../../../backend/src/application/whatsapp_provider_observation_reconciliation.rs)
- [`backend/src/application/whatsapp_runtime_event_projection.rs`](../../../../backend/src/application/whatsapp_runtime_event_projection.rs)
- [`backend/src/application/whatsapp_runtime_signal_ingest.rs`](../../../../backend/src/application/whatsapp_runtime_signal_ingest.rs)
- [`backend/src/application/workflow_action_person_projection.rs`](../../../../backend/src/application/workflow_action_person_projection.rs)
- [`backend/src/application/yandex_telemost_calendar_matching.rs`](../../../../backend/src/application/yandex_telemost_calendar_matching.rs)
- [`backend/src/application/zoom_calendar_matching.rs`](../../../../backend/src/application/zoom_calendar_matching.rs)
- [`backend/src/application/zoom_participant_identity.rs`](../../../../backend/src/application/zoom_participant_identity.rs)
- [`backend/src/application/zoom_signal_detection.rs`](../../../../backend/src/application/zoom_signal_detection.rs)
- [`backend/src/bin/makosh_document_process.rs`](../../../../backend/src/bin/makosh_document_process.rs)
- [`backend/src/bin/makosh_email_fixture_dev.rs`](../../../../backend/src/bin/makosh_email_fixture_dev.rs)
- [`backend/src/bin/makosh_email_fixture_export.rs`](../../../../backend/src/bin/makosh_email_fixture_export.rs)
- [`backend/src/bin/makosh_email_reproject_dev.rs`](../../../../backend/src/bin/makosh_email_reproject_dev.rs)
- [`backend/src/bin/makosh_email_sync_dev.rs`](../../../../backend/src/bin/makosh_email_sync_dev.rs)
- [`backend/src/bin/makosh_email_sync_dev/account.rs`](../../../../backend/src/bin/makosh_email_sync_dev/account.rs)
- [`backend/src/bin/makosh_email_sync_dev/checkpoint.rs`](../../../../backend/src/bin/makosh_email_sync_dev/checkpoint.rs)
- [`backend/src/bin/makosh_email_sync_dev/config.rs`](../../../../backend/src/bin/makosh_email_sync_dev/config.rs)
- [`backend/src/bin/makosh_email_sync_dev/env.rs`](../../../../backend/src/bin/makosh_email_sync_dev/env.rs)
- [`backend/src/bin/makosh_email_sync_dev/errors.rs`](../../../../backend/src/bin/makosh_email_sync_dev/errors.rs)
