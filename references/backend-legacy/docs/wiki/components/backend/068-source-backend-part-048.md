---
chunk_id: 068-source-backend-part-048
...
# 068-source-backend-part-048 — backend/source
...
- [`backend/src/integrations/zoom/client/models.rs`](../../../../backend/src/integrations/zoom/client/models.rs)
- [`backend/src/integrations/zoom/client/store.rs`](../../../../backend/src/integrations/zoom/client/store.rs)
- [`backend/src/integrations/zoom/client/validation.rs`](../../../../backend/src/integrations/zoom/client/validation.rs)
- [`backend/src/integrations/zoom/mod.rs`](../../../../backend/src/integrations/zoom/mod.rs)
- [`backend/src/integrations/zoom/runtime.rs`](../../../../backend/src/integrations/zoom/runtime.rs)
- [`backend/src/lib.rs`](../../../../backend/src/lib.rs)
- [`backend/src/main.rs`](../../../../backend/src/main.rs)
- [`backend/src/platform/ai_runtime.rs`](../../../../backend/src/platform/ai_runtime.rs)
- [`backend/src/platform/audit.rs`](../../../../backend/src/platform/audit.rs)
- [`backend/src/platform/audit/communication.rs`](../../../../backend/src/platform/audit/communication.rs)
- [`backend/src/platform/audit/constants.rs`](../../../../backend/src/platform/audit/constants.rs)
- [`backend/src/platform/audit/documents.rs`](../../../../backend/src/platform/audit/documents.rs)
- [`backend/src/platform/audit/errors.rs`](../../../../backend/src/platform/audit/errors.rs)
- [`backend/src/platform/audit/events.rs`](../../../../backend/src/platform/audit/events.rs)
- [`backend/src/platform/audit/helpers.rs`](../../../../backend/src/platform/audit/helpers.rs)
- [`backend/src/platform/audit/models.rs`](../../../../backend/src/platform/audit/models.rs)
- [`backend/src/platform/audit/reviews.rs`](../../../../backend/src/platform/audit/reviews.rs)
- [`backend/src/platform/audit/settings.rs`](../../../../backend/src/platform/audit/settings.rs)
- [`backend/src/platform/audit/store.rs`](../../../../backend/src/platform/audit/store.rs)
- [`backend/src/platform/audit/telegram.rs`](../../../../backend/src/platform/audit/telegram.rs)
- [`backend/src/platform/audit/telegram_dialogs.rs`](../../../../backend/src/platform/audit/telegram_dialogs.rs)
- [`backend/src/platform/audit/telegram_participants.rs`](../../../../backend/src/platform/audit/telegram_participants.rs)
- [`backend/src/platform/calls.rs`](../../../../backend/src/platform/calls.rs)
- [`backend/src/platform/calls/errors.rs`](../../../../backend/src/platform/calls/errors.rs)
- [`backend/src/platform/calls/models.rs`](../../../../backend/src/platform/calls/models.rs)
