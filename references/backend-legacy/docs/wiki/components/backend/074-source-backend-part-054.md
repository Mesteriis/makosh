---
chunk_id: 074-source-backend-part-054
...
# 074-source-backend-part-054 — backend/source
...
- [`backend/src/workflows/email_intelligence/tests.rs`](../../../../backend/src/workflows/email_intelligence/tests.rs)
- [`backend/src/workflows/email_sync_pipeline.rs`](../../../../backend/src/workflows/email_sync_pipeline.rs)
- [`backend/src/workflows/email_sync_pipeline/attachments.rs`](../../../../backend/src/workflows/email_sync_pipeline/attachments.rs)
- [`backend/src/workflows/email_sync_pipeline/candidates.rs`](../../../../backend/src/workflows/email_sync_pipeline/candidates.rs)
- [`backend/src/workflows/email_sync_pipeline/errors.rs`](../../../../backend/src/workflows/email_sync_pipeline/errors.rs)
- [`backend/src/workflows/email_sync_pipeline/ids.rs`](../../../../backend/src/workflows/email_sync_pipeline/ids.rs)
- [`backend/src/workflows/email_sync_pipeline/knowledge.rs`](../../../../backend/src/workflows/email_sync_pipeline/knowledge.rs)
- [`backend/src/workflows/email_sync_pipeline/organizations.rs`](../../../../backend/src/workflows/email_sync_pipeline/organizations.rs)
- [`backend/src/workflows/email_sync_pipeline/participants.rs`](../../../../backend/src/workflows/email_sync_pipeline/participants.rs)
- [`backend/src/workflows/email_sync_pipeline/raw_payload.rs`](../../../../backend/src/workflows/email_sync_pipeline/raw_payload.rs)
- [`backend/src/workflows/email_sync_pipeline/raw_records.rs`](../../../../backend/src/workflows/email_sync_pipeline/raw_records.rs)
- [`backend/src/workflows/email_sync_pipeline/recording.rs`](../../../../backend/src/workflows/email_sync_pipeline/recording.rs)
- [`backend/src/workflows/email_sync_pipeline/relationships.rs`](../../../../backend/src/workflows/email_sync_pipeline/relationships.rs)
- [`backend/src/workflows/email_sync_pipeline/report.rs`](../../../../backend/src/workflows/email_sync_pipeline/report.rs)
- [`backend/src/workflows/email_sync_pipeline/service.rs`](../../../../backend/src/workflows/email_sync_pipeline/service.rs)
- [`backend/src/workflows/graph_projection.rs`](../../../../backend/src/workflows/graph_projection.rs)
- [`backend/src/workflows/graph_projection/constants.rs`](../../../../backend/src/workflows/graph_projection/constants.rs)
- [`backend/src/workflows/graph_projection/decisions.rs`](../../../../backend/src/workflows/graph_projection/decisions.rs)
- [`backend/src/workflows/graph_projection/documents.rs`](../../../../backend/src/workflows/graph_projection/documents.rs)
- [`backend/src/workflows/graph_projection/errors.rs`](../../../../backend/src/workflows/graph_projection/errors.rs)
- [`backend/src/workflows/graph_projection/evidence.rs`](../../../../backend/src/workflows/graph_projection/evidence.rs)
- [`backend/src/workflows/graph_projection/helpers.rs`](../../../../backend/src/workflows/graph_projection/helpers.rs)
- [`backend/src/workflows/graph_projection/messages.rs`](../../../../backend/src/workflows/graph_projection/messages.rs)
- [`backend/src/workflows/graph_projection/models.rs`](../../../../backend/src/workflows/graph_projection/models.rs)
- [`backend/src/workflows/graph_projection/obligations.rs`](../../../../backend/src/workflows/graph_projection/obligations.rs)
