---
chunk_id: 153-source-frontend-part-013
...
# 153-source-frontend-part-013 — frontend/source
...
- [`frontend/src/integrations/telegram/stores/telegramCommandAudit.ts`](../../../../frontend/src/integrations/telegram/stores/telegramCommandAudit.ts)
- [`frontend/src/integrations/telegram/stores/telegramRuntimeStatus.test.ts`](../../../../frontend/src/integrations/telegram/stores/telegramRuntimeStatus.test.ts)
- [`frontend/src/integrations/telegram/stores/telegramRuntimeStatus.ts`](../../../../frontend/src/integrations/telegram/stores/telegramRuntimeStatus.ts)
- [`frontend/src/integrations/telegram/types/automation.ts`](../../../../frontend/src/integrations/telegram/types/automation.ts)
- [`frontend/src/integrations/telegram/types/telegram.ts`](../../../../frontend/src/integrations/telegram/types/telegram.ts)
- [`frontend/src/integrations/telegram/types/telegramRealtime.ts`](../../../../frontend/src/integrations/telegram/types/telegramRealtime.ts)
- [`frontend/src/integrations/telegram/views/TelegramRuntimePanel.boundary.test.ts`](../../../../frontend/src/integrations/telegram/views/TelegramRuntimePanel.boundary.test.ts)
- [`frontend/src/integrations/whatsapp/api/whatsapp.ts`](../../../../frontend/src/integrations/whatsapp/api/whatsapp.ts)
- [`frontend/src/integrations/whatsapp/api/whatsappCompanion.test.ts`](../../../../frontend/src/integrations/whatsapp/api/whatsappCompanion.test.ts)
- [`frontend/src/integrations/whatsapp/api/whatsappCompanion.ts`](../../../../frontend/src/integrations/whatsapp/api/whatsappCompanion.ts)
- [`frontend/src/integrations/whatsapp/api/whatsappRuntime.test.ts`](../../../../frontend/src/integrations/whatsapp/api/whatsappRuntime.test.ts)
- [`frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimePatchValues.ts`](../../../../frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimePatchValues.ts)
- [`frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimePatches.ts`](../../../../frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimePatches.ts)
- [`frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimeSyncPatches.ts`](../../../../frontend/src/integrations/whatsapp/queries/realtimeWhatsAppRuntimeSyncPatches.ts)
- [`frontend/src/integrations/whatsapp/queries/useWhatsappQuery.ts`](../../../../frontend/src/integrations/whatsapp/queries/useWhatsappQuery.ts)
- [`frontend/src/integrations/whatsapp/queries/useWhatsappRuntimeQuery.ts`](../../../../frontend/src/integrations/whatsapp/queries/useWhatsappRuntimeQuery.ts)
- [`frontend/src/integrations/whatsapp/queries/whatsappQueryKeys.ts`](../../../../frontend/src/integrations/whatsapp/queries/whatsappQueryKeys.ts)
- [`frontend/src/integrations/whatsapp/stores/whatsapp.ts`](../../../../frontend/src/integrations/whatsapp/stores/whatsapp.ts)
- [`frontend/src/integrations/whatsapp/types/whatsapp.ts`](../../../../frontend/src/integrations/whatsapp/types/whatsapp.ts)
- [`frontend/src/integrations/whatsapp/views/WhatsAppRuntimePanel.boundary.test.ts`](../../../../frontend/src/integrations/whatsapp/views/WhatsAppRuntimePanel.boundary.test.ts)
- [`frontend/src/integrations/whatsapp/views/WhatsAppRuntimePanel.helpers.ts`](../../../../frontend/src/integrations/whatsapp/views/WhatsAppRuntimePanel.helpers.ts)
- [`frontend/src/integrations/yandexTelemost/api/yandexTelemost.ts`](../../../../frontend/src/integrations/yandexTelemost/api/yandexTelemost.ts)
- [`frontend/src/integrations/yandexTelemost/queries/useYandexTelemostRuntimeQuery.ts`](../../../../frontend/src/integrations/yandexTelemost/queries/useYandexTelemostRuntimeQuery.ts)
- [`frontend/src/integrations/yandexTelemost/queries/yandexTelemostQueryKeys.ts`](../../../../frontend/src/integrations/yandexTelemost/queries/yandexTelemostQueryKeys.ts)
