---
chunk_id: 144-source-frontend-part-004
...
# 144-source-frontend-part-004 — frontend/source
...
- [`frontend/src/domains/communications/components/MailResourceOverviewStrip.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MailResourceOverviewStrip.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageAiReplyPanel.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageAiReplyPanel.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageAttachmentsTab.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageAttachmentsTab.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageBodyTab.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageBodyTab.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageLocalIntelligencePanel.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageLocalIntelligencePanel.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageRelatedTab.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageRelatedTab.boundary.test.ts)
- [`frontend/src/domains/communications/components/MessageTrustReviewPanel.boundary.test.ts`](../../../../frontend/src/domains/communications/components/MessageTrustReviewPanel.boundary.test.ts)
- [`frontend/src/domains/communications/components/OutboxStatusStrip.boundary.test.ts`](../../../../frontend/src/domains/communications/components/OutboxStatusStrip.boundary.test.ts)
- [`frontend/src/domains/communications/components/RichComposeEditor.boundary.test.ts`](../../../../frontend/src/domains/communications/components/RichComposeEditor.boundary.test.ts)
- [`frontend/src/domains/communications/components/SavedSearchRuleGroupEditor.boundary.test.ts`](../../../../frontend/src/domains/communications/components/SavedSearchRuleGroupEditor.boundary.test.ts)
- [`frontend/src/domains/communications/components/SavedSearchStrip.boundary.test.ts`](../../../../frontend/src/domains/communications/components/SavedSearchStrip.boundary.test.ts)
- [`frontend/src/domains/communications/components/ThreadAttachmentInsightPanel.boundary.test.ts`](../../../../frontend/src/domains/communications/components/ThreadAttachmentInsightPanel.boundary.test.ts)
- [`frontend/src/domains/communications/components/ThreadConversationView.boundary.test.ts`](../../../../frontend/src/domains/communications/components/ThreadConversationView.boundary.test.ts)
- [`frontend/src/domains/communications/components/ThreadInlineReplyComposer.boundary.test.ts`](../../../../frontend/src/domains/communications/components/ThreadInlineReplyComposer.boundary.test.ts)
- [`frontend/src/domains/communications/components/attachmentSearchTable.test.ts`](../../../../frontend/src/domains/communications/components/attachmentSearchTable.test.ts)
- [`frontend/src/domains/communications/components/attachmentSearchTable.ts`](../../../../frontend/src/domains/communications/components/attachmentSearchTable.ts)
- [`frontend/src/domains/communications/components/attachmentTable.test.ts`](../../../../frontend/src/domains/communications/components/attachmentTable.test.ts)
- [`frontend/src/domains/communications/components/attachmentTable.ts`](../../../../frontend/src/domains/communications/components/attachmentTable.ts)
- [`frontend/src/domains/communications/components/mailDragDrop.test.ts`](../../../../frontend/src/domains/communications/components/mailDragDrop.test.ts)
- [`frontend/src/domains/communications/components/mailDragDrop.ts`](../../../../frontend/src/domains/communications/components/mailDragDrop.ts)
- [`frontend/src/domains/communications/components/mailFolderOrdering.test.ts`](../../../../frontend/src/domains/communications/components/mailFolderOrdering.test.ts)
- [`frontend/src/domains/communications/components/mailFolderOrdering.ts`](../../../../frontend/src/domains/communications/components/mailFolderOrdering.ts)
- [`frontend/src/domains/communications/components/mailFolderPresentation.test.ts`](../../../../frontend/src/domains/communications/components/mailFolderPresentation.test.ts)
- [`frontend/src/domains/communications/components/mailFolderPresentation.ts`](../../../../frontend/src/domains/communications/components/mailFolderPresentation.ts)
- [`frontend/src/domains/communications/components/outboxStatus.test.ts`](../../../../frontend/src/domains/communications/components/outboxStatus.test.ts)
