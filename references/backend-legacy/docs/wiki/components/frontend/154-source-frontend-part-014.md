---
chunk_id: 154-source-frontend-part-014
...
# 154-source-frontend-part-014 — frontend/source
...
- [`frontend/src/integrations/yandexTelemost/types/yandexTelemost.ts`](../../../../frontend/src/integrations/yandexTelemost/types/yandexTelemost.ts)
- [`frontend/src/integrations/zoom/api/zoom.test.ts`](../../../../frontend/src/integrations/zoom/api/zoom.test.ts)
- [`frontend/src/integrations/zoom/api/zoom.ts`](../../../../frontend/src/integrations/zoom/api/zoom.ts)
- [`frontend/src/integrations/zoom/components/ZoomBridgeLab.boundary.test.ts`](../../../../frontend/src/integrations/zoom/components/ZoomBridgeLab.boundary.test.ts)
- [`frontend/src/integrations/zoom/components/ZoomObservedCallsPanel.boundary.test.ts`](../../../../frontend/src/integrations/zoom/components/ZoomObservedCallsPanel.boundary.test.ts)
- [`frontend/src/integrations/zoom/components/ZoomSettingsPanel.boundary.test.ts`](../../../../frontend/src/integrations/zoom/components/ZoomSettingsPanel.boundary.test.ts)
- [`frontend/src/integrations/zoom/components/zoomEvidence.test.ts`](../../../../frontend/src/integrations/zoom/components/zoomEvidence.test.ts)
- [`frontend/src/integrations/zoom/components/zoomEvidence.ts`](../../../../frontend/src/integrations/zoom/components/zoomEvidence.ts)
- [`frontend/src/integrations/zoom/queries/useZoomRuntimeQuery.boundary.test.ts`](../../../../frontend/src/integrations/zoom/queries/useZoomRuntimeQuery.boundary.test.ts)
- [`frontend/src/integrations/zoom/queries/useZoomRuntimeQuery.ts`](../../../../frontend/src/integrations/zoom/queries/useZoomRuntimeQuery.ts)
- [`frontend/src/integrations/zoom/queries/zoomQueryKeys.test.ts`](../../../../frontend/src/integrations/zoom/queries/zoomQueryKeys.test.ts)
- [`frontend/src/integrations/zoom/queries/zoomQueryKeys.ts`](../../../../frontend/src/integrations/zoom/queries/zoomQueryKeys.ts)
- [`frontend/src/integrations/zoom/types/zoom.ts`](../../../../frontend/src/integrations/zoom/types/zoom.ts)
- [`frontend/src/main.ts`](../../../../frontend/src/main.ts)
- [`frontend/src/platform/api/ApiClient.ts`](../../../../frontend/src/platform/api/ApiClient.ts)
- [`frontend/src/platform/api/index.ts`](../../../../frontend/src/platform/api/index.ts)
- [`frontend/src/platform/api/types.ts`](../../../../frontend/src/platform/api/types.ts)
- [`frontend/src/platform/bootstrap/api.test.ts`](../../../../frontend/src/platform/bootstrap/api.test.ts)
- [`frontend/src/platform/bootstrap/api.ts`](../../../../frontend/src/platform/bootstrap/api.ts)
- [`frontend/src/platform/bootstrap/businessCommunicationOwnership.boundary.test.ts`](../../../../frontend/src/platform/bootstrap/businessCommunicationOwnership.boundary.test.ts)
- [`frontend/src/platform/bootstrap/realtime.test.ts`](../../../../frontend/src/platform/bootstrap/realtime.test.ts)
- [`frontend/src/platform/bootstrap/realtime.ts`](../../../../frontend/src/platform/bootstrap/realtime.ts)
- [`frontend/src/platform/bootstrap/realtimeCachePatches.test.ts`](../../../../frontend/src/platform/bootstrap/realtimeCachePatches.test.ts)
- [`frontend/src/platform/bootstrap/realtimeMailCachePatches.test.ts`](../../../../frontend/src/platform/bootstrap/realtimeMailCachePatches.test.ts)
- [`frontend/src/platform/bootstrap/realtimeSignalHubInvalidation.test.ts`](../../../../frontend/src/platform/bootstrap/realtimeSignalHubInvalidation.test.ts)
