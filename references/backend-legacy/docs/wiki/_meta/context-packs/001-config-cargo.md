...
- Chunk ID / ID чанка: `001-config-cargo`
- Group / Группа: `.cargo`
- Role / Роль: `config`
...
- Resolved path / Полный путь: `/Users/avm/projects/Personal/makosh/.cargo/config.toml`
- Size bytes / Размер в байтах: `328`
- Included characters / Включено символов: `328`
