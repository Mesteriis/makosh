...
- Chunk ID / ID чанка: `005-config-gitignore`
- Group / Группа: `.gitignore`
- Role / Роль: `config`
...
- Resolved path / Полный путь: `/Users/avm/projects/Personal/makosh/.gitignore`
...
# Python tooling that may be used for scripts later
.venv/
venv/
__pycache__/
*.py[cod]
