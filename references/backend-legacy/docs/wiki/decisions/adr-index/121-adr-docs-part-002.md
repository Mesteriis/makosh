---
chunk_id: 121-adr-docs-part-002
...
# 121-adr-docs-part-002 — docs/adr
...
- [`docs/adr/ADR-0026-desktop-first-responsive-ui.md`](../../../adr/ADR-0026-desktop-first-responsive-ui.md)
- [`docs/adr/ADR-0027-capability-based-permission-model.md`](../../../adr/ADR-0027-capability-based-permission-model.md)
- [`docs/adr/ADR-0028-backup-and-restore-as-core-feature.md`](../../../adr/ADR-0028-backup-and-restore-as-core-feature.md)
- [`docs/adr/ADR-0029-explicit-schema-evolution.md`](../../../adr/ADR-0029-explicit-schema-evolution.md)
- [`docs/adr/ADR-0030-documentation-first-monorepo.md`](../../../adr/ADR-0030-documentation-first-monorepo.md)
- [`docs/adr/ADR-0031-temporary-desktop-only-ui-scope.md`](../../../adr/ADR-0031-temporary-desktop-only-ui-scope.md)
- [`docs/adr/ADR-0032-docker-compose-development-environment.md`](../../../adr/ADR-0032-docker-compose-development-environment.md)
- [`docs/adr/ADR-0033-backend-managed-local-schema-migrations.md`](../../../adr/ADR-0033-backend-managed-local-schema-migrations.md)
- [`docs/adr/ADR-0034-event-replay-and-projection-cursors.md`](../../../adr/ADR-0034-event-replay-and-projection-cursors.md)
- [`docs/adr/ADR-0035-local-event-api-command-boundary.md`](../../../adr/ADR-0035-local-event-api-command-boundary.md)
- [`docs/adr/ADR-0036-projection-runner-checkpoint-semantics.md`](../../../adr/ADR-0036-projection-runner-checkpoint-semantics.md)
- [`docs/adr/ADR-0037-local-write-capability-token.md`](../../../adr/ADR-0037-local-write-capability-token.md)
- [`docs/adr/ADR-0038-local-event-api-capability-token.md`](../../../adr/ADR-0038-local-event-api-capability-token.md)
- [`docs/adr/ADR-0039-local-event-api-access-audit-log.md`](../../../adr/ADR-0039-local-event-api-access-audit-log.md)
- [`docs/adr/ADR-0040-local-api-actor-identity.md`](../../../adr/ADR-0040-local-api-actor-identity.md)
- [`docs/adr/ADR-0041-email-provider-ingestion-foundation.md`](../../../adr/ADR-0041-email-provider-ingestion-foundation.md)
- [`docs/adr/ADR-0042-secret-references-for-provider-credentials.md`](../../../adr/ADR-0042-secret-references-for-provider-credentials.md)
- [`docs/adr/ADR-0043-read-only-email-provider-networking.md`](../../../adr/ADR-0043-read-only-email-provider-networking.md)
- [`docs/adr/ADR-0044-account-setup-and-encrypted-secret-vault.md`](../../../adr/ADR-0044-account-setup-and-encrypted-secret-vault.md)
- [`docs/adr/ADR-0045-graph-core-projection.md`](../../../adr/ADR-0045-graph-core-projection.md)
- [`docs/adr/ADR-0046-persistent-dev-mail-cache-and-blob-storage.md`](../../../adr/ADR-0046-persistent-dev-mail-cache-and-blob-storage.md)
- [`docs/adr/ADR-0047-project-memory-spine.md`](../../../adr/ADR-0047-project-memory-spine.md)
- [`docs/adr/ADR-0048-project-link-review-workflow.md`](../../../adr/ADR-0048-project-link-review-workflow.md)
- [`docs/adr/ADR-0049-v3-local-ai-runtime-and-retrieval.md`](../../../adr/ADR-0049-v3-local-ai-runtime-and-retrieval.md)
- [`docs/adr/ADR-0050-v4-telegram-client-policy-and-call-intelligence.md`](../../../adr/ADR-0050-v4-telegram-client-policy-and-call-intelligence.md)
