use makosh_ai_contracts::communication_reply_inference_contract_reference_v1;
...
use makosh_communications_ai_source_api::{
    ...
    communication_reply_source_prepare_publish_request_v1,
    communication_reply_source_prepared_consume_request_v1,
    communication_reply_source_prepared_contract_reference_v1,
    communication_reply_source_rejected_consume_request_v1,
...
use crate::contracts::{
    reply_suggestion_command_contract_v1, reply_suggestion_query_contract_v1,
    reply_suggestion_realtime_contract_v1,
};

pub const COMMUNICATION_REPLY_SUGGESTION_STORAGE_CAPABILITY_ID_V1: &str =
    "communication_reply_suggestion.storage.v1";
pub const COMMUNICATION_REPLY_SUGGESTION_INFERENCE_CAPABILITY_ID_V1: &str =
    "communication_reply_suggestion.inference.v1";
pub const COMMUNICATION_REPLY_SUGGESTION_BLOB_CAPABILITY_ID_V1: &str =
    "communication_reply_suggestion.source.blob.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn communication_reply_suggestion_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn communication_reply_suggestion_settings_schema_bytes_v1() -> Vec<u8> {
    communication_reply_suggestion_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn communication_reply_suggestion_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    ...
    ModuleDescriptorV1 {
        ...
        display_name: "Communication Reply Suggestion".to_owned(),
    }
}

fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_REPLY_SUGGESTION_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::BlobQuota(BlobQuotaRequestV1 {
                max_bytes: 2 * 1024 * 1024,
                custody_scope_id: COMMUNICATION_REPLY_SUGGESTION_OWNER_V1.to_owned(),
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_REPLY_SUGGESTION_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
            client_surface(
                reply_suggestion_command_contract_v1(),
                COMMUNICATION_REPLY_SUGGESTION_COMMAND_CONNECT_PATH_V1,
            ),
            client_surface(
                reply_suggestion_query_contract_v1(),
                COMMUNICATION_REPLY_SUGGESTION_QUERY_CONNECT_PATH_V1,
            ),
            ProvidedSurfaceV1 {
                kind: ProvidedSurfaceKindV1::ClientRealtime as i32,
                contract: Some(reply_suggestion_realtime_contract_v1()),
...
fn inference_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_REPLY_SUGGESTION_INFERENCE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        dependencies: vec![communication_reply_inference_contract_reference_v1()],
        ..Default::default()
    }
}
...
fn source_prepare_capability() -> CapabilityDescriptorV1 {
    event_capability(
        "communication_reply_suggestion.source_prepare.v1",
...
fn source_prepared_capability() -> CapabilityDescriptorV1 {
    event_capability(
        "communication_reply_suggestion.source_prepared.v1",
...
fn source_rejected_capability() -> CapabilityDescriptorV1 {
    event_capability(
        "communication_reply_suggestion.source_rejected.v1",
        ProvidedSurfaceKindV1::DurableConsumer,
        communication_reply_source_rejected_contract_reference_v1(),
        communication_reply_source_rejected_consume_request_v1(),
    )
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_REPLY_SUGGESTION_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_exact_workflow_with_event_only_source_and_request_rpc_ai() {
        let descriptor = communication_reply_suggestion_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&communication_reply_suggestion_settings_schema_v1())
            .expect("settings");
        ...
        assert_eq!(
            ...
            vec![communication_reply_inference_contract_reference_v1()]
        );
    }
}
