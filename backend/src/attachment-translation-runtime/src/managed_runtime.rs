...
use makosh_attachment_translation_api::ATTACHMENT_TRANSLATION_OWNER_V1;
...
use crate::{
    client_port::{
        AttachmentTranslationClientRuntimeContextV1,
        dispatch_attachment_translation_client_request_v1,
    },
    client_realtime::{
        AttachmentTranslationClientRealtimeErrorV1, AttachmentTranslationClientRealtimePublisherV1,
    },
    consume_translation_source_prepared_once_v1, consume_translation_source_rejected_once_v1,
    event_outbox::AttachmentTranslationEventRelayErrorV1,
    inference::AttachmentTranslationInferenceErrorV1,
    recover_attachment_translation_once_v1, relay_source_prepare_outbox_once_v1,
    source_results::AttachmentTranslationSourceResultErrorV1,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct AttachmentTranslationRuntimeAdmissionV1 {
...
pub enum AttachmentTranslationManagedRuntimeErrorV1 {
    Admission,
    EventContract,
    EventUnavailable,
    InvalidTransition,
...
pub struct AttachmentTranslationManagedRuntimeV1 {
    admission: AttachmentTranslationRuntimeAdmissionV1,
    ...
    client_realtime: AttachmentTranslationClientRealtimePublisherV1,
}

impl AttachmentTranslationManagedRuntimeV1 {
    pub async fn open(
    ...
    ) -> Result<Self, AttachmentTranslationManagedRuntimeErrorV1> {
        validate_admission(admission)?;
        if event_hub_endpoint.trim().is_empty() || event_credential_revision == 0 {
            return Err(AttachmentTranslationManagedRuntimeErrorV1::Admission);
        }
        ...
        let vault_public_key = storage_configuration
            ...
            .as_slice()
            .try_into()
            .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::Admission)?;
        ...
        let password = std::str::from_utf8(&password)
            .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::Admission)?;
        let persistence = AttachmentTranslationPersistenceV1::connect_runtime(
            &binding,
        ...
        .await
        .map_err(AttachmentTranslationManagedRuntimeErrorV1::Persistence)?;
        persistence
        ...
        .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::EventUnavailable)?;
        ...
        .await
        .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::EventUnavailable)?;
        let mut client_realtime = AttachmentTranslationClientRealtimePublisherV1::default();
        ...
        control_channel
            ...
            .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::Unavailable)?;
        Ok(Self {
    ...
    pub async fn relay_source_prepare_outbox_once(
        &self,
        now_unix_millis: i64,
    ) -> Result<bool, AttachmentTranslationManagedRuntimeErrorV1> {
    ...
    pub async fn process_inference_once(
        ...
        self.control_channel
            ...
            .map_err(|_| AttachmentTranslationManagedRuntimeErrorV1::Unavailable)?;
        let mut dispatcher = RejectManagedControlRequestsV2;
        let result = recover_attachment_translation_once_v1(
            &self.persistence,
            &mut self.control_channel,
            &mut dispatcher,
            &self.admission.logical_owner_id,
    ...
    pub async fn pump_control_once(
        ...
        if validate_module_client_response_v1(&response).is_err() {
            return Err(AttachmentTranslationManagedRuntimeErrorV1::Unavailable);
        }
        self.control_channel
            .write_response(
                correlation_id,
    ...
    fn write_client_error(
        ...
        error_code: &str,
    ) -> Result<(), AttachmentTranslationManagedRuntimeErrorV1> {
        self.control_channel
            .write_response(
                correlation_id,
                ManagedRuntimeControlResponseV1 {
...
fn bind_source_subscriptions(
    ...
    AttachmentTranslationManagedRuntimeErrorV1,
> {
    if permits.len() != 2 {
        return Err(AttachmentTranslationManagedRuntimeErrorV1::Admission);
    }
...
fn exact_permit(
...
) -> Result<RuntimeSubscribePermitV1, AttachmentTranslationManagedRuntimeErrorV1> {
    ...
    let permit = matching
        .next()
        .cloned()
        .ok_or(AttachmentTranslationManagedRuntimeErrorV1::Admission)?;
...
async fn resolve_storage_credential(
...
) -> Result<zeroize::Zeroizing<Vec<u8>>, AttachmentTranslationManagedRuntimeErrorV1> {
    for attempt in 0..20 {
    ...
    Err(AttachmentTranslationManagedRuntimeErrorV1::Unavailable)
}

fn storage_binding(
    configuration: &ManagedStorageRuntimeConfigurationV1,
    admission: &AttachmentTranslationRuntimeAdmissionV1,
) -> Result<StorageBindingV1, AttachmentTranslationManagedRuntimeErrorV1> {
...
fn storage_owner_is_exact(logical_owner_id: &str, owner: &str) -> bool {
    logical_owner_id == owner && owner == ATTACHMENT_TRANSLATION_OWNER_V1
}

fn event_relay_error(
    error: AttachmentTranslationEventRelayErrorV1,
) -> AttachmentTranslationManagedRuntimeErrorV1 {
    match error {
        AttachmentTranslationEventRelayErrorV1::InvalidTimestamp => {
            AttachmentTranslationManagedRuntimeErrorV1::EventContract
        }
        AttachmentTranslationEventRelayErrorV1::Persistence(error) => {
            AttachmentTranslationManagedRuntimeErrorV1::Persistence(error)
        }
        AttachmentTranslationEventRelayErrorV1::EventUnavailable => {
            AttachmentTranslationManagedRuntimeErrorV1::EventUnavailable
        }
    }
}

fn source_result_error(
    error: AttachmentTranslationSourceResultErrorV1,
) -> AttachmentTranslationManagedRuntimeErrorV1 {
    match error {
        AttachmentTranslationSourceResultErrorV1::InvalidEnvelope
        | AttachmentTranslationSourceResultErrorV1::InvalidPayload => {
            AttachmentTranslationManagedRuntimeErrorV1::EventContract
        }
        AttachmentTranslationSourceResultErrorV1::Blob(
            crate::AttachmentTranslationBlobErrorV1::InvalidReceipt,
        ) => AttachmentTranslationManagedRuntimeErrorV1::EventContract,
        AttachmentTranslationSourceResultErrorV1::Blob(
            crate::AttachmentTranslationBlobErrorV1::Unavailable,
        ) => AttachmentTranslationManagedRuntimeErrorV1::Unavailable,
        AttachmentTranslationSourceResultErrorV1::Inference(error) => inference_error(error),
        AttachmentTranslationSourceResultErrorV1::Persistence(error) => {
            AttachmentTranslationManagedRuntimeErrorV1::Persistence(error)
        }
...
fn inference_error(
    error: AttachmentTranslationInferenceErrorV1,
) -> AttachmentTranslationManagedRuntimeErrorV1 {
    match error {
        AttachmentTranslationInferenceErrorV1::InvalidRequest
        | AttachmentTranslationInferenceErrorV1::InvalidResult => {
            AttachmentTranslationManagedRuntimeErrorV1::InvalidTransition
        }
        AttachmentTranslationInferenceErrorV1::Blob(
            crate::AttachmentTranslationBlobErrorV1::InvalidReceipt,
        ) => AttachmentTranslationManagedRuntimeErrorV1::InvalidTransition,
        AttachmentTranslationInferenceErrorV1::Blob(
            crate::AttachmentTranslationBlobErrorV1::Unavailable,
        ) => AttachmentTranslationManagedRuntimeErrorV1::Unavailable,
        AttachmentTranslationInferenceErrorV1::Persistence(error) => {
            AttachmentTranslationManagedRuntimeErrorV1::Persistence(error)
        }
        AttachmentTranslationInferenceErrorV1::Unavailable => {
            AttachmentTranslationManagedRuntimeErrorV1::Unavailable
        }
    }
}
...
fn client_realtime_error(
    error: AttachmentTranslationClientRealtimeErrorV1,
) -> AttachmentTranslationManagedRuntimeErrorV1 {
    match error {
        AttachmentTranslationClientRealtimeErrorV1::InvalidTransition => {
            AttachmentTranslationManagedRuntimeErrorV1::InvalidTransition
        }
        AttachmentTranslationClientRealtimeErrorV1::Persistence(error) => {
            AttachmentTranslationManagedRuntimeErrorV1::Persistence(error)
        }
        AttachmentTranslationClientRealtimeErrorV1::Unavailable => {
            AttachmentTranslationManagedRuntimeErrorV1::Unavailable
        }
    }
}
...
mod tests {
    ...
    fn admission_requires_exact_managed_fences() {
        assert_eq!(
            validate_admission(&AttachmentTranslationRuntimeAdmissionV1 {
    ...
    fn module_identity_is_exact_workflow_unit() {
        assert_eq!(
            makosh_attachment_translation_api::ATTACHMENT_TRANSLATION_MODULE_ID_V1,
