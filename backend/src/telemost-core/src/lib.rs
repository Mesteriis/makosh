...
pub const PACKAGE: &str = "makosh-telemost-core";
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct YandexTelemostCallObservationV1 {
...
pub enum YandexTelemostCoreErrorV1 {
    InvalidObservation,
}
pub fn sanitize_call_observation_v1(
    value: &YandexTelemostCallObservationV1,
) -> Result<CallEvidenceObservationDraftV1, YandexTelemostCoreErrorV1> {
    ...
    let draft = CallEvidenceObservationDraftV1 {
        ...
        provider: CallProviderProvenanceV1::YandexTelemost,
    ...
    draft
        .validate()
        .map_err(|_| YandexTelemostCoreErrorV1::InvalidObservation)?;
    Ok(draft)
}
#[cfg(test)]
mod tests {
    ...
    fn sanitizes_to_exact_provider_without_private_locators() {
        let value = YandexTelemostCallObservationV1 {
        ...
        assert_eq!(draft.provider, CallProviderProvenanceV1::YandexTelemost);
