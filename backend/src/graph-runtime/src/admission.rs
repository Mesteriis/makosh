use makosh_graph_api::{
    ...
    GRAPH_PROJECTION_CAPABILITY_ID_V1, GRAPH_STORAGE_CAPABILITY_ID_V1, graph_client_routes_v1,
};
...
#[must_use]
pub fn graph_settings_schema_bytes_v1() -> Vec<u8> {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn graph_module_descriptor_v1(build: &str) -> ModuleDescriptorV1 {
    let settings = graph_settings_schema_bytes_v1();
    let mut capabilities = vec![client(), projection(), storage()];
    capabilities.sort_by(|a, b| a.capability_id.cmp(&b.capability_id));
    ModuleDescriptorV1 {
        descriptor_major: 1,
        descriptor_revision: 1,
        module_id: GRAPH_MODULE_ID_V1.into(),
        owner_id: GRAPH_OWNER_ID_V1.into(),
        ...
        display_name: "Graph".into(),
    }
}
fn client() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: GRAPH_CLIENT_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: graph_client_routes_v1()
            .into_iter()
...
fn projection() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: GRAPH_PROJECTION_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
...
fn storage() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: GRAPH_STORAGE_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
...
mod tests {
    ...
    fn descriptor_is_three_capability_read_only_projection() {
        let value = graph_module_descriptor_v1("test");
