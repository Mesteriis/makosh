#![forbid(unsafe_code)]
//! Unsigned release assembly for the retained-evidence replay workflow.
...
pub const RUNTIME_ARTIFACT_ID_V1: &str = "attachment_preview_evidence_replay.runtime.v1";
pub const STORAGE_ARTIFACT_ID_V1: &str = "attachment_preview_evidence_replay.storage.v1";
pub const DESCRIPTOR_FILE_V1: &str = "attachment_preview_evidence_replay.runtime.descriptor.pb";
pub const SETTINGS_FILE_V1: &str = "attachment_preview_evidence_replay.runtime.settings.pb";
pub const STORAGE_BUNDLE_FILE_V1: &str = "attachment_preview_evidence_replay.storage.bundle.pb";
pub const ARTIFACT_FRAGMENT_FILE_V1: &str =
    "attachment_preview_evidence_replay.release-artifacts.json";

const RUNTIME_RELATIVE_PATH_V1: &str = "bin/makosh-attachment-preview-evidence-replay-runtime";
const DESCRIPTOR_RELATIVE_PATH_V1: &str =
    "contracts/attachment_preview_evidence_replay.runtime.descriptor.pb";
const SETTINGS_RELATIVE_PATH_V1: &str =
    "contracts/attachment_preview_evidence_replay.runtime.settings.pb";
const STORAGE_RELATIVE_PATH_V1: &str =
    "storage/attachment_preview_evidence_replay.storage.bundle.pb";
...
pub fn materialize_attachment_preview_evidence_replay_release_assembly_v1(
    output_directory: &Path,
    build_id: &str,
    runtime_source: &Path,
) -> Result<ReleaseAssemblyPathsV1, ReleaseAssemblyErrorV1> {
    validate_inputs(output_directory, build_id, runtime_source)?;
    let descriptor = attachment_preview_evidence_replay_module_descriptor_v1(build_id);
    let settings = attachment_preview_evidence_replay_settings_schema_v1();
    let storage = attachment_preview_evidence_replay_storage_bundle_v1();
...
mod tests {
    ...
    fn materializes_exact_unsigned_workflow_artifacts() {
        ...
        let paths = materialize_attachment_preview_evidence_replay_release_assembly_v1(
        ...
        assert_eq!(descriptor.owner_id, "attachment_preview_evidence_replay");
        assert_eq!(storage.owner_id, "attachment_preview_evidence_replay");
        assert_eq!(fragment.owner_id, "attachment_preview_evidence_replay");
    ...
    fn temporary_directory() -> PathBuf {
        ...
        let path = std::env::temp_dir().join(format!(
            "makosh-attachment-preview-evidence-replay-assembly-{}-{id}",
            std::process::id()
        ));
