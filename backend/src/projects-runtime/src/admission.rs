use makosh_projects_api::{
    PROJECTS_CLIENT_CAPABILITY_ID_V1, PROJECTS_LIFECYCLE_EVENT_CAPABILITY_ID_V1,
    PROJECTS_MODULE_ID_V1, PROJECTS_OWNER_ID_V1, PROJECTS_STORAGE_CAPABILITY_ID_V1,
    projects_client_routes_v1, projects_lifecycle_event_contract_reference_v1,
    projects_lifecycle_event_publish_request_v1,
};
...
pub(crate) const PROJECTS_RUNTIME_CAPABILITY_IDS_V1: [&str; 3] = [
    "projects.client.v1",
...
#[must_use]
pub fn projects_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn projects_settings_schema_bytes_v1() -> Vec<u8> {
    projects_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn projects_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    ...
    debug_assert_eq!(
        capabilities
            ...
            .collect::<Vec<_>>(),
        PROJECTS_RUNTIME_CAPABILITY_IDS_V1,
    );
    ModuleDescriptorV1 {
        descriptor_major: 1,
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: PROJECTS_CLIENT_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: projects_client_routes_v1()
            .into_iter()
...
fn lifecycle_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: PROJECTS_LIFECYCLE_EVENT_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        ...
        requests: vec![projects_lifecycle_event_publish_request_v1()],
        ..Default::default()
    }
}
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: PROJECTS_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
...
mod tests {
    ...
    fn descriptor_is_exact_provider_neutral_domain() {
        let descriptor = projects_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&projects_settings_schema_v1()).expect("settings");
        assert_eq!(descriptor.module_kind, ModuleKindV1::Domain as i32);
        assert_eq!(descriptor.capabilities.len(), 3);
        assert_eq!(descriptor.capabilities[0].provides.len(), 13);
