use makosh_review_obligation_candidate_api::{
    ...
    review_obligation_candidate_submission_rejected_publish_request_v1,
    review_obligation_candidate_submit_consume_request_v1,
    review_obligation_candidate_submit_contract_reference_v1,
    review_obligation_candidate_submitted_contract_reference_v1,
    review_obligation_candidate_submitted_publish_request_v1,
};
use makosh_review_obligation_candidate_promotion_api::{
    review_obligation_candidate_promotion_result_consume_request_v1,
...
pub const REVIEW_OBLIGATION_CANDIDATE_STORAGE_CAPABILITY_ID_V1: &str =
    "review.obligation-candidate.storage.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn review_obligation_candidate_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn review_obligation_candidate_settings_schema_bytes_v1() -> Vec<u8> {
    review_obligation_candidate_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn review_obligation_candidate_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    let settings = review_obligation_candidate_settings_schema_bytes_v1();
    ModuleDescriptorV1 {
        descriptor_major: 1,
        ...
        capabilities: vec![
            event_capability(
                "review.obligation-candidate.approved.publisher.v1",
            ...
            event_capability(
                "review.obligation-candidate.rejected.publisher.v1",
                ProvidedSurfaceKindV1::DurablePublisher,
                review_obligation_candidate_submission_rejected_contract_reference_v1(),
                review_obligation_candidate_submission_rejected_publish_request_v1(),
            ),
            ...
            event_capability(
                "review.obligation-candidate.submitted.publisher.v1",
                ProvidedSurfaceKindV1::DurablePublisher,
                review_obligation_candidate_submitted_contract_reference_v1(),
                review_obligation_candidate_submitted_publish_request_v1(),
            ),
        ...
        display_name: "Review Obligation Candidates".to_owned(),
    }
}

fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_OBLIGATION_CANDIDATE_CLIENT_CAPABILITY_ID_V1.to_owned(),
        ...
        provides: vec![
            ...
            client_surface(
                query_contract_v1(),
                REVIEW_OBLIGATION_CANDIDATE_QUERY_CONNECT_PATH_V1,
            ),
            client_surface(
                list_contract_v1(),
                REVIEW_OBLIGATION_CANDIDATE_LIST_CONNECT_PATH_V1,
            ),
            ProvidedSurfaceV1 {
...
fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_OBLIGATION_CANDIDATE_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_OBLIGATION_CANDIDATE_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_a_distinct_review_domain_with_event_only_promotion() {
        let descriptor = review_obligation_candidate_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&review_obligation_candidate_settings_schema_v1())
            .expect("settings");
