...
use makosh_mail_delivery_intent_contract::{
    MAIL_DELIVERY_INTENT_TARGET_CAPABILITY_ID_V1, MAIL_DELIVERY_INTENT_TARGET_MODULE_ID_V1,
    mail_delivery_intent_execute_contract_reference_v1,
    mail_delivery_intent_rejected_contract_reference_v1,
    mail_delivery_intent_succeeded_contract_reference_v1, validate_mail_delivery_intent_execute_v1,
    validate_mail_delivery_intent_rejected_v1, validate_mail_delivery_intent_succeeded_v1,
    wire::{
        ExecuteMailDeliveryIntentCommandV1, MailDeliveryIntentBodySourceReceiptV1,
        MailDeliveryIntentRejectedV1, MailDeliveryIntentSucceededV1,
    },
};
use prost::Message;
...
pub fn build_execute_outbox_v1(
    ...
    validate_mail_delivery_intent_execute_v1(&payload)
...
pub fn decode_succeeded_v1(
    ...
    let payload = MailDeliveryIntentSucceededV1::decode(envelope.payload.as_slice())
        .map_err(|_| DeliveryIntentEventAdapterErrorV1::InvalidPayload)?;
