...
use makosh_zulip_delivery_intent_contract::{
    ZULIP_DELIVERY_INTENT_TARGET_CAPABILITY_ID_V1, ZULIP_DELIVERY_INTENT_TARGET_MODULE_ID_V1,
    validate_zulip_delivery_intent_execute_v1, validate_zulip_delivery_intent_rejected_v1,
    validate_zulip_delivery_intent_succeeded_v1,
    wire::{
        ExecuteZulipDeliveryIntentCommandV1, ZulipDeliveryIntentBodySourceReceiptV1,
        ZulipDeliveryIntentRejectedV1, ZulipDeliveryIntentSucceededV1,
    },
...
pub fn build_execute_outbox_v1(
    ...
    validate_zulip_delivery_intent_execute_v1(&payload)
...
pub fn decode_succeeded_v1(
    ...
    let payload = ZulipDeliveryIntentSucceededV1::decode(envelope.payload.as_slice())
        .map_err(|_| DeliveryIntentEventAdapterErrorV1::InvalidPayload)?;
