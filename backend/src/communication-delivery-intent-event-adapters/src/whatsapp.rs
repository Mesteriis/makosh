...
use makosh_whatsapp_delivery_intent_contract::{
    ...
    wire::{
        ExecuteWhatsAppDeliveryIntentCommandV1, WhatsAppDeliveryIntentBodySourceReceiptV1,
        WhatsAppDeliveryIntentRejectedV1, WhatsAppDeliveryIntentSucceededV1,
    },
};
use prost::Message;
...
pub fn build_execute_outbox_v1(
    ...
    validate_whatsapp_delivery_intent_execute_v1(&payload)
...
pub fn decode_succeeded_v1(
    ...
    let payload = WhatsAppDeliveryIntentSucceededV1::decode(envelope.payload.as_slice())
        .map_err(|_| DeliveryIntentEventAdapterErrorV1::InvalidPayload)?;
