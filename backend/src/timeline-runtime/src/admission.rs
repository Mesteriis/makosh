...
use makosh_timeline_api::{
    ...
    TIMELINE_PROJECTION_CAPABILITY_ID_V1, TIMELINE_STORAGE_CAPABILITY_ID_V1,
    timeline_client_routes_v1,
};
use prost::Message;
use sha2::{Digest, Sha256};
#[must_use]
pub fn timeline_settings_schema_bytes_v1() -> Vec<u8> {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn timeline_module_descriptor_v1(build: &str) -> ModuleDescriptorV1 {
    let settings = timeline_settings_schema_bytes_v1();
    let mut capabilities = vec![client(), projection(), storage()];
    capabilities.sort_by(|a, b| a.capability_id.cmp(&b.capability_id));
    ModuleDescriptorV1 {
        descriptor_major: 1,
        descriptor_revision: 1,
        module_id: TIMELINE_MODULE_ID_V1.into(),
        owner_id: TIMELINE_OWNER_ID_V1.into(),
...
fn client() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TIMELINE_CLIENT_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: timeline_client_routes_v1()
            .into_iter()
...
fn projection() -> CapabilityDescriptorV1 {
    ...
    CapabilityDescriptorV1 {
        capability_id: TIMELINE_PROJECTION_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: contracts
            .into_iter()
...
fn storage() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TIMELINE_STORAGE_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
...
mod tests {
    ...
    fn descriptor_is_exact_read_only_projection() {
        let value = timeline_module_descriptor_v1("test");
