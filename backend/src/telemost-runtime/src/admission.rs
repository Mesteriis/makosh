...
use makosh_telemost_api::{
    TELEMOST_ACCOUNT_CLIENT_CAPABILITY_ID_V1, TELEMOST_CALL_EVIDENCE_CAPABILITY_ID_V1,
    TELEMOST_CREDENTIAL_PROVISION_CAPABILITY_ID_V1, TELEMOST_CREDENTIAL_PURPOSE_ID_V1,
    TELEMOST_CREDENTIAL_RESOLVE_CAPABILITY_ID_V1, TELEMOST_MODULE_ID_V1, TELEMOST_OWNER_ID_V1,
    TELEMOST_PROVIDER_CAPABILITY_ID_V1, TELEMOST_STORAGE_CAPABILITY_ID_V1,
    telemost_client_routes_v1, telemost_settings_schema_bytes_v1,
};
use sha2::{Digest, Sha256};
#[must_use]
pub fn telemost_module_descriptor_v1(build: &str) -> ModuleDescriptorV1 {
    let settings = telemost_settings_schema_bytes_v1();
    let mut capabilities = vec![
        client(),
        events(),
        provider(),
        vault(
            TELEMOST_CREDENTIAL_PROVISION_CAPABILITY_ID_V1,
            vec![
        ...
        vault(
            TELEMOST_CREDENTIAL_RESOLVE_CAPABILITY_ID_V1,
    ...
    ModuleDescriptorV1 {
        ...
        module_id: TELEMOST_MODULE_ID_V1.into(),
        owner_id: TELEMOST_OWNER_ID_V1.into(),
        ...
        display_name: "Yandex Telemost".into(),
    }
}
fn client() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TELEMOST_ACCOUNT_CLIENT_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: telemost_client_routes_v1()
            .into_iter()
...
fn events() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TELEMOST_CALL_EVIDENCE_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
...
fn provider() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TELEMOST_PROVIDER_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        ..Default::default()
    }
    ...
    CapabilityDescriptorV1 {
        ...
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::VaultPurpose(VaultPurposeRequestV1 {
                purpose_id: TELEMOST_CREDENTIAL_PURPOSE_ID_V1.into(),
...
fn storage() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: TELEMOST_STORAGE_CAPABILITY_ID_V1.into(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_has_exact_six_separate_capabilities() {
        let d = telemost_module_descriptor_v1("test");
