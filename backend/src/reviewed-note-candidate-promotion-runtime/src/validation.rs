...
pub(crate) fn id16(value: &[u8]) -> Result<[u8; 16], ReviewedNoteCandidatePromotionEventErrorV1> {
    value
        .try_into()
        .ok()
...
pub(crate) fn id32(value: &[u8]) -> Result<[u8; 32], ReviewedNoteCandidatePromotionEventErrorV1> {
    value
        .try_into()
        .ok()
