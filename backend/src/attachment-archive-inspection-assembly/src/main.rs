...
fn main() -> ExitCode {
    ...
    if materialize_archive_inspection_release_assembly_v1(
    ...
    println!("attachment-archive-inspection-release-assembly: ok");
    ExitCode::SUCCESS
}
...
fn fail(message: &str) -> ExitCode {
    eprintln!("attachment-archive-inspection-release-assembly: {message}");
    ExitCode::FAILURE
}
