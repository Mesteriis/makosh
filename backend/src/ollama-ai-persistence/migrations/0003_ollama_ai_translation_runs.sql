CREATE TABLE makosh_data.ollama_ai_translation_runs (
    ...
    CHECK (
        (run_state IN (1, 2, 5) AND result_terminal_status IS NULL
            ...
            AND result_model_revision_sha256 IS NULL AND result_input_tokens IS NULL
            AND result_output_tokens IS NULL AND result_completeness IS NULL
        ...
        OR (run_state = 3 AND result_terminal_status = 1
            ...
            AND result_input_tokens >= 0 AND result_output_tokens > 0
