...
pub const KNOWLEDGE_STORAGE_BUNDLE_REVISION_V2: u32 = 2;
pub const KNOWLEDGE_SCHEMA_V2: &[u8] =
    include_bytes!("../migrations/0002_knowledge_lifecycle_owner_rls.sql");

#[must_use]
pub fn knowledge_storage_bundle_v1() -> StorageBundleV1 {
    StorageBundleV1 {
        major: 1,
        revision: KNOWLEDGE_STORAGE_BUNDLE_REVISION_V2,
        ...
        steps: vec![
            ...
            StorageMigrationStepV1 {
                ...
                forward_sql_utf8: KNOWLEDGE_SCHEMA_V2.to_vec(),
                sha256: Sha256::digest(KNOWLEDGE_SCHEMA_V2).to_vec(),
            },
        ],
    }
}
...
mod tests {
    ...
    fn bundle_is_knowledge_owned_and_cross_owner_negative() {
        ...
        let lifecycle = std::str::from_utf8(KNOWLEDGE_SCHEMA_V2).expect("utf8");
        for required in [
            "knowledge_sources",
            "knowledge_client_operations",
            "ENABLE ROW LEVEL SECURITY",
            "FORCE ROW LEVEL SECURITY",
            "makosh.logical_owner_id",
        ] {
