...
pub struct PersistPromotionApprovalV1 {
    ...
    pub obligations_id: [u8; 16],
    pub obligations_outbox: OutboxRecordV1,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReviewedObligationCandidatePromotionOutcomeV1 {
    Succeeded { obligation_id: [u8; 16] },
...
pub struct PersistPromotionTerminalResultV1 {
    pub logical_owner_id: String,
    pub obligations_result_message_id: [u8; 16],
    pub obligations_result_envelope_sha256: [u8; 32],
    pub obligations_id: [u8; 16],
    pub review_id: [u8; 16],
    pub candidate_id: [u8; 16],
    pub outcome: ReviewedObligationCandidatePromotionOutcomeV1,
