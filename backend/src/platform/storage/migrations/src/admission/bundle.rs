...
fn is_exact_zoom_v1_bundle(bundle: &StorageBundleV1) -> bool {
    const SHA: [u8; 32] = [
        0x39, 0xd0, 0xbf, 0xf3, 0xc2, 0x8a, 0x8c, 0x63, 0x32, 0x64, 0xe5, 0x14, 0x4e, 0x44, 0xd2,
        0x65, 0xf1, 0x4f, 0xda, 0xc6, 0x5b, 0xf4, 0x29, 0xe0, 0x84, 0x0c, 0xc0, 0xa3, 0xae, 0x75,
        0xf1, 0x12,
    ];
...
fn is_exact_telemost_v1_bundle(bundle: &StorageBundleV1) -> bool {
    const SHA: [u8; 32] = [
        0x27, 0xa5, 0xb2, 0xe6, 0x48, 0xa1, 0x5b, 0x4c, 0xfc, 0xe8, 0xa0, 0xdb, 0xde, 0x11, 0xbd,
        0x41, 0x48, 0x06, 0xc9, 0xab, 0x5c, 0xed, 0xa4, 0xeb, 0x2a, 0x32, 0x5d, 0x1f, 0x5c, 0x95,
        0xb5, 0xc9,
    ];
...
fn is_exact_omniroute_v1_bundle(bundle: &StorageBundleV1) -> bool {
    const SHA: [u8; 32] = [
        0x5f, 0x75, 0x4c, 0x13, 0x63, 0xd8, 0x7a, 0x2c, 0x0d, 0x23, 0x2b, 0x40, 0x90, 0x18, 0x5b,
        0xb2, 0x3a, 0x92, 0xb6, 0x56, 0x11, 0x95, 0xa7, 0xa5, 0xd8, 0x87, 0xd4, 0xfb, 0xb8, 0x2e,
        0x9e, 0xa4,
    ];
...
fn is_exact_task21_owner_storage_bundle(bundle: &StorageBundleV1) -> bool {
    ...
    (bundle.bundle_id == "obligations"
        ...
        || (bundle.bundle_id == "review_obligation_candidate"
            && bundle.owner_id == "review_obligation_candidate"
            && owner_rls.revision == 2
