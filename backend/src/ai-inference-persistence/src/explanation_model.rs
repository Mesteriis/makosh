...
pub struct PersistedAiExplanationRunV1 {
    pub run: AiExplanationRunV1,
    pub selected_provider_settings_revision: Option<u64>,
}

#[derive(Clone, Debug, PartialEq)]
pub struct AiExplanationTransitionV1 {
    pub current_revision: u64,
    pub next_run: AiExplanationRunV1,
}

#[derive(Clone, Debug, PartialEq)]
pub struct AiExplanationPersistenceOutcomeV1 {
    pub persisted: PersistedAiExplanationRunV1,
    pub replayed: bool,
}
...
pub(crate) fn validate_explanation_run(
    ...
    validate_explanation_inference_request_v1(&run.request)
...
pub(crate) fn validate_explanation_transition(
    current: &PersistedAiExplanationRunV1,
...
pub(crate) fn validate_explanation_persisted(
