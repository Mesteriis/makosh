...
pub struct PersistedAiSummaryRunV1 {
    pub run: AiSummaryRunV1,
    pub selected_provider_settings_revision: Option<u64>,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct AiSummaryTransitionV1 {
    pub current_revision: u64,
    pub next_run: AiSummaryRunV1,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct AiSummaryPersistenceOutcomeV1 {
    pub persisted: PersistedAiSummaryRunV1,
    pub replayed: bool,
}
...
pub(crate) fn validate_summary_run(
    ...
    validate_summary_inference_request_v1(&run.request)
...
pub(crate) fn validate_summary_transition(
    current: &PersistedAiSummaryRunV1,
...
pub(crate) fn validate_summary_persisted(
