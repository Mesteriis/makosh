use makosh_review_note_candidate_api::{
    ...
    REVIEW_NOTE_CANDIDATE_QUERY_CONNECT_PATH_V1, REVIEW_NOTE_CANDIDATE_SUBMISSION_CAPABILITY_ID_V1,
    review_note_candidate_approved_contract_reference_v1,
    review_note_candidate_approved_publish_request_v1,
    review_note_candidate_submission_rejected_contract_reference_v1,
    review_note_candidate_submission_rejected_publish_request_v1,
    review_note_candidate_submit_consume_request_v1,
...
pub const REVIEW_NOTE_CANDIDATE_STORAGE_CAPABILITY_ID_V1: &str = "review.note-candidate.storage.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn review_note_candidate_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn review_note_candidate_settings_schema_bytes_v1() -> Vec<u8> {
    review_note_candidate_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn review_note_candidate_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    let settings = review_note_candidate_settings_schema_bytes_v1();
    ModuleDescriptorV1 {
        descriptor_major: 1,
        descriptor_revision: 1,
        module_id: REVIEW_NOTE_CANDIDATE_MODULE_ID_V1.to_owned(),
        owner_id: REVIEW_NOTE_CANDIDATE_OWNER_V1.to_owned(),
        ...
        capabilities: vec![
            event_capability(
                "review.note-candidate.approved.publisher.v1",
            ...
            event_capability(
                "review.note-candidate.rejected.publisher.v1",
                ProvidedSurfaceKindV1::DurablePublisher,
                review_note_candidate_submission_rejected_contract_reference_v1(),
                review_note_candidate_submission_rejected_publish_request_v1(),
            ),
            storage_capability(),
            event_capability(
                REVIEW_NOTE_CANDIDATE_SUBMISSION_CAPABILITY_ID_V1,
                ProvidedSurfaceKindV1::DurableConsumer,
                review_note_candidate_submit_contract_reference_v1(),
                review_note_candidate_submit_consume_request_v1(),
            ),
            event_capability(
                "review.note-candidate.submitted.publisher.v1",
                ProvidedSurfaceKindV1::DurablePublisher,
                review_note_candidate_submitted_contract_reference_v1(),
                review_note_candidate_submitted_publish_request_v1(),
            ),
        ...
        display_name: "Review Note Candidates".to_owned(),
    }
}

fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_NOTE_CANDIDATE_CLIENT_CAPABILITY_ID_V1.to_owned(),
...
fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_NOTE_CANDIDATE_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::BlobQuota(BlobQuotaRequestV1 {
                max_bytes: 2 * 1024 * 1024,
                custody_scope_id: REVIEW_NOTE_CANDIDATE_OWNER_V1.to_owned(),
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: REVIEW_NOTE_CANDIDATE_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_a_distinct_review_domain_with_event_only_promotion() {
        let descriptor = review_note_candidate_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&review_note_candidate_settings_schema_v1()).expect("settings");
        ...
        assert!(
            descriptor
                .capabilities
                .iter()
                .all(|capability| !capability.capability_id.contains("knowledge"))
        );
    }
}
