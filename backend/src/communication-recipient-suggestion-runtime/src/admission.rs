...
use makosh_communications_recipient_source_api::{
    ...
    communication_recipient_source_prepare_publish_request_v1,
    communication_recipient_source_prepared_consume_request_v1,
    communication_recipient_source_prepared_contract_reference_v1,
    communication_recipient_source_rejected_consume_request_v1,
...
use crate::contracts::{
    ...
    communication_recipient_suggestion_realtime_contract_v1,
};

pub const COMMUNICATION_RECIPIENT_SUGGESTION_STORAGE_CAPABILITY_ID_V1: &str =
    "communication_recipient_suggestion.storage.v1";
pub const COMMUNICATION_RECIPIENT_SUGGESTION_BLOB_CAPABILITY_ID_V1: &str =
    "communication_recipient_suggestion.source.blob.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn communication_recipient_suggestion_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn communication_recipient_suggestion_settings_schema_bytes_v1() -> Vec<u8> {
    communication_recipient_suggestion_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn communication_recipient_suggestion_module_descriptor_v1(
    build_id: &str,
) -> ModuleDescriptorV1 {
    ...
    ModuleDescriptorV1 {
        ...
        display_name: "Communication Recipient Suggestion".to_owned(),
    }
}

fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_RECIPIENT_SUGGESTION_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::BlobQuota(BlobQuotaRequestV1 {
                max_bytes: 2 * 1024 * 1024,
                custody_scope_id: COMMUNICATION_RECIPIENT_SUGGESTION_OWNER_V1.to_owned(),
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_RECIPIENT_SUGGESTION_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
            client_surface(
            ...
            ProvidedSurfaceV1 {
                ...
                contract: Some(communication_recipient_suggestion_realtime_contract_v1()),
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_RECIPIENT_SUGGESTION_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    #[test]
    fn descriptor_is_exact_workflow_with_event_only_source_and_local_evaluation() {
        let descriptor = communication_recipient_suggestion_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&communication_recipient_suggestion_settings_schema_v1())
            .expect("settings");
