...
pub const REVIEW_TASK_CANDIDATE_STORAGE_BUNDLE_REVISION_V2: u32 = 2;
pub const REVIEW_TASK_CANDIDATE_SCHEMA_V1: &[u8] =
    include_bytes!("../migrations/0001_review_task_candidate.sql");
pub const REVIEW_TASK_CANDIDATE_OWNER_RLS_SCHEMA_V2: &[u8] =
    include_bytes!("../migrations/0002_review_task_candidate_owner_rls.sql");

#[must_use]
pub fn review_task_candidate_storage_bundle_v1() -> StorageBundleV1 {
    StorageBundleV1 {
        major: 1,
        revision: REVIEW_TASK_CANDIDATE_STORAGE_BUNDLE_REVISION_V2,
        ...
        steps: vec![
            ...
            StorageMigrationStepV1 {
                revision: REVIEW_TASK_CANDIDATE_STORAGE_BUNDLE_REVISION_V2,
                migration_id: "review_task_candidate_owner_rls".to_owned(),
                forward_sql_utf8: REVIEW_TASK_CANDIDATE_OWNER_RLS_SCHEMA_V2.to_vec(),
                sha256: Sha256::digest(REVIEW_TASK_CANDIDATE_OWNER_RLS_SCHEMA_V2).to_vec(),
            },
        ],
    }
}
