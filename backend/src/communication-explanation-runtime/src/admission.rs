use makosh_ai_contracts::communication_explanation_inference_contract_reference_v1;
...
use makosh_communications_ai_source_api::{
    ...
    communication_explanation_source_prepare_publish_request_v1,
    communication_explanation_source_prepared_consume_request_v1,
    communication_explanation_source_prepared_contract_reference_v1,
    communication_explanation_source_rejected_consume_request_v1,
...
use crate::contracts::{
    ...
    communication_explanation_realtime_contract_v1,
};

pub const COMMUNICATION_EXPLANATION_STORAGE_CAPABILITY_ID_V1: &str =
    "communication_explanation.storage.v1";
pub const COMMUNICATION_EXPLANATION_INFERENCE_CAPABILITY_ID_V1: &str =
    "communication_explanation.inference.v1";
pub const COMMUNICATION_EXPLANATION_BLOB_CAPABILITY_ID_V1: &str =
    "communication_explanation.source.blob.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn communication_explanation_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn communication_explanation_settings_schema_bytes_v1() -> Vec<u8> {
    communication_explanation_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn communication_explanation_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    ...
    ModuleDescriptorV1 {
        ...
        display_name: "Communication Explanation".to_owned(),
    }
}

fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_EXPLANATION_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::BlobQuota(BlobQuotaRequestV1 {
                max_bytes: 2 * 1024 * 1024,
                custody_scope_id: COMMUNICATION_EXPLANATION_OWNER_V1.to_owned(),
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_EXPLANATION_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
            client_surface(
                communication_explanation_command_contract_v1(),
                COMMUNICATION_EXPLANATION_COMMAND_CONNECT_PATH_V1,
            ),
            client_surface(
                communication_explanation_query_contract_v1(),
                COMMUNICATION_EXPLANATION_QUERY_CONNECT_PATH_V1,
            ),
            ProvidedSurfaceV1 {
                kind: ProvidedSurfaceKindV1::ClientRealtime as i32,
                contract: Some(communication_explanation_realtime_contract_v1()),
...
fn inference_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_EXPLANATION_INFERENCE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        dependencies: vec![communication_explanation_inference_contract_reference_v1()],
        ..Default::default()
    }
}
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_EXPLANATION_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_exact_workflow_with_event_only_source_and_request_rpc_ai() {
        let descriptor = communication_explanation_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&communication_explanation_settings_schema_v1())
            .expect("settings");
        ...
        assert_eq!(
            ...
            vec![communication_explanation_inference_contract_reference_v1()]
        );
    }
}
