CREATE TABLE makosh_data.communication_recipient_suggestion_runs (
...
ON makosh_data.communication_recipient_suggestion_runs (
    logical_owner_id,
    state,
    state_revision
);

CREATE TABLE makosh_data.communication_recipient_suggestion_inbox (
    logical_owner_id TEXT NOT NULL,
...
CREATE TABLE makosh_data.communication_recipient_suggestion_outbox (
    logical_owner_id TEXT NOT NULL,
...
ON makosh_data.communication_recipient_suggestion_outbox (
    logical_owner_id,
...
CREATE TABLE makosh_data.communication_recipient_suggestion_realtime (
...
ON makosh_data.communication_recipient_suggestion_realtime (
    logical_owner_id,
    realtime_sequence
);
