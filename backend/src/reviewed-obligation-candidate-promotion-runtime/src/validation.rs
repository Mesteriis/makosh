...
use crate::obligation_results::ReviewedObligationCandidatePromotionEventErrorV1;

pub(crate) fn validate_contract(
    envelope: &DurableEnvelopeV1,
    expected: &ContractReferenceV1,
) -> Result<(), ReviewedObligationCandidatePromotionEventErrorV1> {
    if envelope
        .contract
        .as_ref()
...
pub(crate) fn id16(
    value: &[u8],
) -> Result<[u8; 16], ReviewedObligationCandidatePromotionEventErrorV1> {
    value
        .try_into()
        .ok()
...
pub(crate) fn id32(
    value: &[u8],
) -> Result<[u8; 32], ReviewedObligationCandidatePromotionEventErrorV1> {
    value
        .try_into()
        .ok()
