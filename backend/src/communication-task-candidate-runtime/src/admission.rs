...
use makosh_communications_task_source_api::{
    ...
    communication_task_source_prepare_publish_request_v1,
    communication_task_source_prepared_consume_request_v1,
...
use crate::contracts::{
    ...
    communication_task_candidate_realtime_contract_v1,
};

pub const COMMUNICATION_TASK_CANDIDATE_STORAGE_CAPABILITY_ID_V1: &str =
...
#[must_use]
pub fn communication_task_candidate_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn communication_task_candidate_settings_schema_bytes_v1() -> Vec<u8> {
    communication_task_candidate_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn communication_task_candidate_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    let settings = communication_task_candidate_settings_schema_bytes_v1();
    ModuleDescriptorV1 {
        descriptor_major: 1,
        ...
        display_name: "Communication Task Candidate Extraction".to_owned(),
    }
}

fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TASK_CANDIDATE_BLOB_CAPABILITY_ID_V1.to_owned(),
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TASK_CANDIDATE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
            client_surface(
            ...
            ProvidedSurfaceV1 {
                ...
                contract: Some(communication_task_candidate_realtime_contract_v1()),
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TASK_CANDIDATE_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_exact_workflow_with_event_only_source_and_local_extraction() {
        let descriptor = communication_task_candidate_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&communication_task_candidate_settings_schema_v1())
            .expect("settings");
