...
pub(crate) fn communication_translation_query_contract_v1() -> ContractReferenceV1 {
    contract(COMMUNICATION_TRANSLATION_QUERY_CONTRACT_NAME_V1)
}

pub(crate) fn communication_translation_realtime_contract_v1() -> ContractReferenceV1 {
    contract(COMMUNICATION_TRANSLATION_REALTIME_CONTRACT_NAME_V1)
}
