use makosh_ai_contracts::communication_translation_inference_contract_reference_v1;
...
use makosh_communications_ai_source_api::{
    ...
    communication_translation_source_prepare_publish_request_v1,
    communication_translation_source_prepared_consume_request_v1,
    communication_translation_source_prepared_contract_reference_v1,
    communication_translation_source_rejected_consume_request_v1,
...
use crate::contracts::{
    ...
    communication_translation_realtime_contract_v1,
};

pub const COMMUNICATION_TRANSLATION_STORAGE_CAPABILITY_ID_V1: &str =
    "communication_translation.storage.v1";
pub const COMMUNICATION_TRANSLATION_INFERENCE_CAPABILITY_ID_V1: &str =
    "communication_translation.inference.v1";
pub const COMMUNICATION_TRANSLATION_BLOB_CAPABILITY_ID_V1: &str =
    "communication_translation.source.blob.v1";
const STORAGE_CONNECTION_BUDGET_V1: u32 = 4;

#[must_use]
pub fn communication_translation_settings_schema_v1() -> SettingsSchemaV1 {
    SettingsSchemaV1 {
        major: 1,
        revision: 1,
        definitions: Vec::new(),
...
#[must_use]
pub fn communication_translation_settings_schema_bytes_v1() -> Vec<u8> {
    communication_translation_settings_schema_v1().encode_to_vec()
}

#[must_use]
pub fn communication_translation_module_descriptor_v1(build_id: &str) -> ModuleDescriptorV1 {
    ...
    ModuleDescriptorV1 {
        ...
        display_name: "Communication Translation".to_owned(),
    }
}

fn blob_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TRANSLATION_BLOB_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
            request: Some(Request::BlobQuota(BlobQuotaRequestV1 {
                max_bytes: 2 * 1024 * 1024,
                custody_scope_id: COMMUNICATION_TRANSLATION_OWNER_V1.to_owned(),
...
fn client_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TRANSLATION_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        provides: vec![
            client_surface(
                communication_translation_command_contract_v1(),
                COMMUNICATION_TRANSLATION_COMMAND_CONNECT_PATH_V1,
            ),
            client_surface(
                communication_translation_query_contract_v1(),
                COMMUNICATION_TRANSLATION_QUERY_CONNECT_PATH_V1,
            ),
            ProvidedSurfaceV1 {
...
fn inference_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TRANSLATION_INFERENCE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        dependencies: vec![communication_translation_inference_contract_reference_v1()],
        ..Default::default()
    }
}
...
fn storage_capability() -> CapabilityDescriptorV1 {
    CapabilityDescriptorV1 {
        capability_id: COMMUNICATION_TRANSLATION_STORAGE_CAPABILITY_ID_V1.to_owned(),
        capability_revision: 1,
        criticality: CapabilityCriticalityV1::Required as i32,
        requests: vec![CapabilityRequestV1 {
...
mod tests {
    ...
    fn descriptor_is_exact_workflow_with_event_only_source_and_request_rpc_ai() {
        let descriptor = communication_translation_module_descriptor_v1("test");
        validate_descriptor_v1(&descriptor).expect("descriptor");
        validate_settings_schema_v1(&communication_translation_settings_schema_v1())
            .expect("settings");
        ...
        assert_eq!(
            ...
            vec![communication_translation_inference_contract_reference_v1()]
        );
    }
}
