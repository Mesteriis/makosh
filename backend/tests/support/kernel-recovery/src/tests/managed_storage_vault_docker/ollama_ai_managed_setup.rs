...
pub(super) fn start_ollama_ai_runtime_v1(
    ...
    start_reserved_ollama_ai_runtime_v1(
        supervisor,
        store,
        kernel_data,
        runtime_dir,
...
pub(super) fn restart_ollama_ai_runtime_v1(
    ...
    let successor = start_reserved_ollama_ai_runtime_v1(
        supervisor,
        store,
        kernel_data,
        runtime_dir,
...
fn start_reserved_ollama_ai_runtime_v1(
    supervisor: &ManagedRuntimeSupervisor,
    store: &SqliteControlStore,
    kernel_data: &Path,
    runtime_dir: &Path,
    ...
    managed_launch::start_reserved_integration(
        ...
        managed_launch::ManagedIntegrationLaunchConfiguration {
            ...
            settings_snapshot_bytes: ollama_ai_settings_snapshot_v1(ollama_port).encode_to_vec(),
            granted_capability_ids: &admitted.capability_ids,
        },
    )
    .expect("start managed Ollama AI integration");
    supervisor
